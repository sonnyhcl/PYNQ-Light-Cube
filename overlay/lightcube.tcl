...
################################################################
# This is a generated script based on design: Light_Cube_PYNQ_BRAM
#
...
# source Light_Cube_PYNQ_BRAM_script.tcl
...
set design_name Light_Cube_PYNQ_BRAM
...
proc create_root_design { parentCell } {
  ...
  # Create ports
  set done_ctr2slv [ create_bd_port -dir O done_ctr2slv ]
  set init_slv2ctr [ create_bd_port -dir O init_slv2ctr ]
  set mode_ctr2lcc [ create_bd_port -dir O mode_ctr2lcc ]
  set rck [ create_bd_port -dir O rck ]
  set sck [ create_bd_port -dir O sck ]
  set ser [ create_bd_port -dir O ser ]

  # Create instance: AXI_LC_0, and set properties
  set AXI_LC_0 [ create_bd_cell -type ip -vlnv xilinx.com:user:AXI_LC:1.2 AXI_LC_0 ]
...
CONFIG.NUM_MI {2} \
  ...
  connect_bd_intf_net -intf_net AXI_LC_0_M_AXI [get_bd_intf_pins AXI_LC_0/M_AXI] [get_bd_intf_pins axi_mem_intercon/S00_AXI]
  ...
  connect_bd_intf_net -intf_net processing_system7_0_axi_periph_M01_AXI [get_bd_intf_pins AXI_LC_0/S_AXI] [get_bd_intf_pins processing_system7_0_axi_periph/M01_AXI]

  # Create port connections
  connect_bd_net -net AXI_LC_0_done_ctr2slv [get_bd_ports done_ctr2slv] [get_bd_pins AXI_LC_0/done_ctr2slv]
  connect_bd_net -net AXI_LC_0_init_slv2ctr [get_bd_ports init_slv2ctr] [get_bd_pins AXI_LC_0/init_slv2ctr]
  connect_bd_net -net AXI_LC_0_mode_ctr2lcc [get_bd_ports mode_ctr2lcc] [get_bd_pins AXI_LC_0/mode_ctr2lcc]
  connect_bd_net -net AXI_LC_0_rck [get_bd_ports rck] [get_bd_pins AXI_LC_0/rck]
  connect_bd_net -net AXI_LC_0_sck [get_bd_ports sck] [get_bd_pins AXI_LC_0/sck]
  connect_bd_net -net AXI_LC_0_ser [get_bd_ports ser] [get_bd_pins AXI_LC_0/ser]
  connect_bd_net -net processing_system7_0_FCLK_CLK0 [get_bd_pins AXI_LC_0/m_axi_aclk] [get_bd_pins AXI_LC_0/s_axi_aclk] [get_bd_pins axi_bram_ctrl_0/s_axi_aclk] [get_bd_pins axi_bram_ctrl_1/s_axi_aclk] [get_bd_pins axi_mem_intercon/ACLK] [get_bd_pins axi_mem_intercon/M00_ACLK] [get_bd_pins axi_mem_intercon/S00_ACLK] [get_bd_pins processing_system7_0/FCLK_CLK0] [get_bd_pins processing_system7_0/M_AXI_GP0_ACLK] [get_bd_pins processing_system7_0_axi_periph/ACLK] [get_bd_pins processing_system7_0_axi_periph/M00_ACLK] [get_bd_pins processing_system7_0_axi_periph/M01_ACLK] [get_bd_pins processing_system7_0_axi_periph/S00_ACLK] [get_bd_pins rst_processing_system7_0_50M/slowest_sync_clk]
  ...
  connect_bd_net -net rst_processing_system7_0_50M_peripheral_aresetn [get_bd_pins AXI_LC_0/m_axi_aresetn] [get_bd_pins AXI_LC_0/s_axi_aresetn] [get_bd_pins axi_bram_ctrl_0/s_axi_aresetn] [get_bd_pins axi_bram_ctrl_1/s_axi_aresetn] [get_bd_pins axi_mem_intercon/M00_ARESETN] [get_bd_pins axi_mem_intercon/S00_ARESETN] [get_bd_pins processing_system7_0_axi_periph/M00_ARESETN] [get_bd_pins processing_system7_0_axi_periph/M01_ARESETN] [get_bd_pins processing_system7_0_axi_periph/S00_ARESETN] [get_bd_pins rst_processing_system7_0_50M/peripheral_aresetn]

  # Create address segments
  create_bd_addr_seg -range 0x00002000 -offset 0x40000000 [get_bd_addr_spaces AXI_LC_0/M_AXI] [get_bd_addr_segs axi_bram_ctrl_1/S_AXI/Mem0] SEG_axi_bram_ctrl_1_Mem0
  create_bd_addr_seg -range 0x00010000 -offset 0x43C00000 [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs AXI_LC_0/S_AXI/S_AXI_reg] SEG_AXI_LC_0_S_AXI_reg
...
#  -string -flagsOSRD
preplace port sck -pg 1 -y 560 -defaultsOSRD
preplace port DDR -pg 1 -y 370 -defaultsOSRD
preplace port done_ctr2slv -pg 1 -y 480 -defaultsOSRD
preplace port ser -pg 1 -y 520 -defaultsOSRD
preplace port mode_ctr2lcc -pg 1 -y 500 -defaultsOSRD
preplace port FIXED_IO -pg 1 -y 390 -defaultsOSRD
preplace port rck -pg 1 -y 540 -defaultsOSRD
preplace port init_slv2ctr -pg 1 -y 460 -defaultsOSRD
preplace inst rst_processing_system7_0_50M -pg 1 -lvl 1 -y 250 -defaultsOSRD
preplace inst blk_mem_gen_0 -pg 1 -lvl 6 -y 290 -defaultsOSRD
preplace inst AXI_LC_0 -pg 1 -lvl 3 -y 510 -defaultsOSRD
...
preplace inst axi_bram_ctrl_1 -pg 1 -lvl 5 -y 300 -defaultsOSRD
preplace inst processing_system7_0 -pg 1 -lvl 1 -y 410 -defaultsOSRD
preplace netloc processing_system7_0_DDR 1 1 6 NJ 370 NJ 370 NJ 370 NJ 370 NJ 370 NJ
preplace netloc AXI_LC_0_done_ctr2slv 1 3 4 NJ 480 NJ 480 NJ 480 NJ
preplace netloc AXI_LC_0_mode_ctr2lcc 1 3 4 NJ 500 NJ 500 NJ 500 NJ
preplace netloc processing_system7_0_axi_periph_M00_AXI 1 2 1 N
preplace netloc rst_processing_system7_0_50M_interconnect_aresetn 1 1 3 390 80 NJ 80 NJ
preplace netloc axi_bram_ctrl_0_BRAM_PORTA 1 3 3 NJ 230 NJ 230 1550
preplace netloc processing_system7_0_M_AXI_GP0 1 1 1 400
preplace netloc AXI_LC_0_M_AXI 1 3 1 980
preplace netloc processing_system7_0_FCLK_RESET0_N 1 0 2 30 510 390
preplace netloc axi_mem_intercon_M00_AXI 1 4 1 1310
preplace netloc AXI_LC_0_rck 1 3 4 NJ 540 NJ 540 NJ 540 NJ
preplace netloc rst_processing_system7_0_50M_peripheral_aresetn 1 1 4 420 360 740 310 1010 320 NJ
preplace netloc AXI_LC_0_init_slv2ctr 1 3 4 NJ 460 NJ 460 NJ 460 NJ
preplace netloc processing_system7_0_FIXED_IO 1 1 6 NJ 390 NJ 390 NJ 390 NJ 390 NJ 390 NJ
preplace netloc AXI_LC_0_sck 1 3 4 NJ 560 NJ 560 NJ 560 NJ
preplace netloc AXI_LC_0_ser 1 3 4 NJ 520 NJ 520 NJ 520 NJ
preplace netloc processing_system7_0_FCLK_CLK0 1 0 5 20 500 410 420 730 300 1000 300 NJ
preplace netloc axi_bram_ctrl_1_BRAM_PORTA 1 5 1 N
preplace netloc processing_system7_0_axi_periph_M01_AXI 1 2 1 720
levelinfo -pg 1 0 210 570 860 1160 1430 1650 1770 -top 0 -bot 630
",
}
